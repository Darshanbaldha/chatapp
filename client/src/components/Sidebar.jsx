            ...
            <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? 'max-md:hidden' : ''}`}>
                <div className="pb-5">
                    ...
                    <div className="rounded-full bg-[#282142] flex items-center gap-2 py-3 px-4 mt-5">
                        ...
                        <input type="text" onChange={(e) => setInput(e.target.value)} name="" id="" className="bg-tarnsparent border-none outline-none text-white text-xs flex-1 placeolder-[#c8c8c8]" placeholder="Search User" />
                    </div>
                </div>
